...
| step-1/fix-bad-tests | `flutter test` (sequential, all packages) | 34s | Fixed async delays, heavy setUp, real I/O, split mega files |
| step-2/parallel-packages | `sh/check-ci.sh` | 17s | Parallel package execution |
